...
class ClientsPage(Base):
    ...
    def add_new_client(self, client_data: dict):
        ...
        self.fill_first_name(client_data['first_name'])
        self.fill_last_name(client_data['last_name'])
        self.fill_ssn(client_data['ssn'])
        self.fill_email(client_data['email'])
        self.fill_mobile(client_data['mobile'])
        self.fill_city(client_data['city'])
        self.fill_state(client_data['state'])
        self.fill_advisor(client_data['advisor_name'])
